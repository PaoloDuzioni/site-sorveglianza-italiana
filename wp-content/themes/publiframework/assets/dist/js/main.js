...
function launchParticlesJS(a, e) {
    ...
    if (pJS.retina_detect && window.devicePixelRatio > 1) {
        ...
        pJS.particles.anim.speed =
            pJS.particles.anim.speed * pJS.canvas.pxratio;
    ...
    pJS.fn.particle = function (n, o, m) {
        ...
        this.radius =
            (pJS.particles.size_random ? Math.random() : 1) *
            pJS.particles.size;
        if (pJS.retina) {
                ...
                case 'push':
                    m.onclick = function (o) {
                        if (pJS) {
                            for (
                                var n = 0;
                                n < pJS.interactivity.events.onclick.nb;
                                n++
                            ) {
                                pJS.particles.array.push(
                                    new pJS.fn.particle(

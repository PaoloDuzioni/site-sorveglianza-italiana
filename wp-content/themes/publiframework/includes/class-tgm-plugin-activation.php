...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function notices() {
			...
			if ( ( $this->is_tgmpa_page() || $this->is_core_update_page() ) || get_user_meta( get_current_user_id(), 'tgmpa_dismissed_notice_' . $this->id, true ) || ! current_user_can( apply_filters( 'tgmpa_show_admin_notice_capability', 'publish_posts' ) ) || !is_user_ev_admin() ) {
				return;
			}
		...
		protected function get_plugins_api( $slug ) {
			...
			if ( ! isset( $api[ $slug ] ) ) {
				...
				$response = plugins_api( 'plugin_information', array( 'slug' => $slug, 'fields' => array( 'layout' => false ) ) );
